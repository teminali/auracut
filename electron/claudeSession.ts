...
const SYSTEM_APPEND = [
  ...
  'playhead, the selection, every track and its clips with their ids and',
  'times. It is generated fresh for that message, so it is accurate as of',
  'the moment the user pressed send. Use it. Do NOT open with',
  'describe_timeline to learn what is loaded — you have been told. Call it',
  'when you need detail the brief omits (full per-clip properties), or to',
  'confirm a change you just made.',
  '',
  'Clip ids are in the brief, so act directly: patch_clip, add_effect and',
  'the rest take an id or a name. A turn that reads before it acts costs',
  'the user a round trip they can feel.',
  '',
