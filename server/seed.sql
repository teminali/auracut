...
INSERT INTO skills (id, name, summary, description, author_name, major_version,
                    ...
                    status, verified_at, verified_build, created_at, updated_at)
VALUES
...
INSERT INTO skill_versions (skill_id, version, r2_key, size_bytes, sha256, tool_api, released_at)
VALUES
  ('beat-montage', '1.0.0', 'skills/beat-montage/1.0.0.kerfskill', 0,
   'seed-placeholder-replaced-on-publish', 1, strftime('%s','now') * 1000),
